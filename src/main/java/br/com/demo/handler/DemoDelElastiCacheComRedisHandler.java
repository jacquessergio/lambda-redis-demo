...
public class DemoDelElastiCacheComRedisHandler extends DemoRedisConfig
		implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {

	private static final Logger LOG = LoggerFactory.getLogger(DemoDelElastiCacheComRedisHandler.class);
	...
	public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent header, Context context) {
		...
		try {
			...
			response = "{\"data\":\"" + cacheComRedis.del(chave) + "\"}";
